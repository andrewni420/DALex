...
class Constants:
    def setConstants(self,par,i=0):
        ...
        self.outFileName = os.path.join(par['outputDirectory'], str(par['outputFile'])+f'/exp{i}/eLCS')     #Saved as text
        os.makedirs(par['outputDirectory']+f"/{par['outputFile']}/exp{i}",exist_ok=True)
